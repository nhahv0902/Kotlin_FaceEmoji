...
import com.nhahv.faceemoji.networking.error.BaseException
            ...
            if (throwable is HttpException) {
                ...
                if (response.errorBody() != null) {
                    try {
                        ...
                        return if (errorResponse != null && !TextUtils.isEmpty(
                                errorResponse.messages)) {
                            BaseException.toServerError(errorResponse as BaseResponse<ErrorMessage>)
                        } else {
